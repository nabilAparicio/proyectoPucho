                ...
                <div className="w-full max-w-md ">
                    <form className="bg-slate-100 shadow-2xl rounded-lg px-12 pt-6 pb-8 mb-4">
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline focus:border focus:border-blue-500 focus:shadow-xl"
