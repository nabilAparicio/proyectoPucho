                ...
                <div className="w-full max-w-md ">
                    <form className="bg-slate-100 shadow-2xl rounded-lg px-12 pt-6 pb-8 mb-4">
                        ...
                        <div className="flex items-center justify-between">
                            <button className="px-4 py-2 rounded text-white inline-block shadow-lg bg-blue-500 hover:bg-blue-600 focus:bg-blue-700"  onClick={tryLogin} type="button">Sign In</button>
